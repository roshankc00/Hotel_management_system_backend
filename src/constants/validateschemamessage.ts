export const validateUserModel={
    REQUIRED_EMAIL_MESSAGE:"email field is requried",
    VALID_EMAIL_MESSAGE:"please enter the valid email",
...
export const validateTestinomialMessage={
...
export const validateStafMessage={
    ...
    REQUIRED_phoneNumber_MESSAGE:"phone number field id required",
    
    REQUIRED_salary_MESSAGE:"salary field id required",

    REQUIRED_position_MESSAGE:"position field id required",

    REQUIRED_email_MESSAGE:"email field id required",
...
export const validateRoomMessage={
    ...
    REQUIRED_USER_MESSAGE:"USER field id required in rating field",
